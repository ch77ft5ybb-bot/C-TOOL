...
// ===== P action check =====
// General proportional control convention:
// PB[%] = input-span percentage required for a 100% output change.
// With manual reset/bias fixed at 50%, SP=PV corresponds to 50% output.
function getPidKp(){
...
if("serviceWorker" in navigator && location.protocol!=="file:"){
  ...
  window.addEventListener("load",async()=>{
    try{
      ...
      const reg=await navigator.serviceWorker.register("service-worker-v2.2.js",{updateViaCache:"none"});
      await reg.update();
